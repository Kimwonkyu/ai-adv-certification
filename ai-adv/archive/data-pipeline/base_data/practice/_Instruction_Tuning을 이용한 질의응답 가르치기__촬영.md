...
print(convert_format('안녕?', answer='그래 안녕')['text'])
...
sft_config = SFTConfig(
    ...
    per_device_train_batch_size=4, # T4= 2
...
# 개인 계정 주소에 업로드하기
model.push_to_hub(f'{username}/{model_save_dir}_Instruct')
tokenizer.push_to_hub(f'{username}/{model_save_dir}_Instruct')
...
model_id="NotoriousH2/gemma-3-1b-pt-MED_CPT-Instruct_CPT"
# 모델의 주소
# (로컬 주소도 가능)
